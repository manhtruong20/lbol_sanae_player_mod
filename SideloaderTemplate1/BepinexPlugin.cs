...
namespace SanaeStar
{
    [BepInPlugin(SanaeStar.PInfo.GUID, SanaeStar.PInfo.Name, SanaeStar.PInfo.version)]
    ...
    public class BepinexPlugin : BaseUnityPlugin
    {
        ...
        private static readonly Harmony harmony = SanaeStar.PInfo.harmony;
        ...
        internal static DirectorySource directorySource = new DirectorySource(SanaeStar.PInfo.GUID, "");


        internal static BatchLocalization SanaeStarCardsBatchloc =
             new BatchLocalization(BepinexPlugin.directorySource, typeof(CardTemplate), "SanaeStarLocCards");

        internal static BatchLocalization SanaeStarPlayerUnitBatchloc =
            new BatchLocalization(BepinexPlugin.directorySource, typeof(PlayerUnitTemplate), "SanaeStarLocPlayerUnit");

        internal static BatchLocalization SanaeStarModelBatchloc =
            new BatchLocalization(BepinexPlugin.directorySource, typeof(UnitModelTemplate), "SanaeStarLocModel");
